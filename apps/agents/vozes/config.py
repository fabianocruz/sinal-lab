...
VOZES_SOURCES: list[DataSourceConfig] = [
    ...
    # --- LinkedIn via FreshData RapidAPI ---
    # Company pages: posts from top LATAM tech companies
    DataSourceConfig(
        name="linkedin_co_nubank",
        source_type="linkedin_fresh_company",
    ...
    DataSourceConfig(
        name="linkedin_co_creditas",
        source_type="linkedin_fresh_company",
        url="https://www.linkedin.com/company/creditas/",
        api_key_env="RAPIDAPI_KEY",
        enabled=True,
        params={"limit": 5},
    ),
    DataSourceConfig(
        name="linkedin_co_clip",
        source_type="linkedin_fresh_company",
        url="https://www.linkedin.com/company/clip-mx/",
        api_key_env="RAPIDAPI_KEY",
        enabled=True,
        params={"limit": 5},
    ),
    # Profile posts: key LATAM tech voices
    DataSourceConfig(
        name="linkedin_voice_davidvelez",
        source_type="linkedin_fresh_profile",
        url="https://www.linkedin.com/in/davidvelez/",
        api_key_env="RAPIDAPI_KEY",
        enabled=True,
        params={"limit": 5},
    ),
    DataSourceConfig(
        name="linkedin_voice_cristinajunqueira",
        source_type="linkedin_fresh_profile",
        url="https://www.linkedin.com/in/cristinajunqueira/",
        api_key_env="RAPIDAPI_KEY",
        enabled=True,
        params={"limit": 5},
    ),
    DataSourceConfig(
        name="linkedin_voice_marcelclauret",
        source_type="linkedin_fresh_profile",
        url="https://www.linkedin.com/in/marcelclauret/",
        api_key_env="RAPIDAPI_KEY",
        enabled=True,
        params={"limit": 5},
    ),
