...
ART_DIRECTOR_SYSTEM_PROMPT = (
    ...
    "- Single coin, group of coins, gold coins, crypto coins floating, coin stacks (ANY coin imagery)\n"
    "- Floating digital currency symbols ($, €, BTC) — these are visual junk-food\n"
    "- Generic credit cards floating in space (UNLESS the story is specifically about a card product)\n"
    ...
    "ANTI-CLICHÉ ENFORCEMENT (MOST IMPORTANT RULE):\n"
    "Even when the story is ABOUT money, capital, fintech, crypto, or payments, the cover "
    "MUST NOT show coins, cash, currency symbols, or generic payment imagery as the hero. "
    "Pick a NON-FINANCIAL physical metaphor that captures the underlying story:\n"
    "- 'Stripe announces 288 products at Sessions' → a vast architectural stage at night with "
    "{agent_color_name} spotlights converging on a single empty podium (the stage of commerce)\n"
    "- 'Tether enters Argentina via belo' → close-up of a translucent USDT-shaped object "
    "anchoring into the Buenos Aires Obelisco like a mooring rope, with {agent_color_name} fog\n"
    "- 'Stablecoins for corporate treasury' → close-up of a corporate steel safe whose front "
    "panel dissolves into pixels of {agent_color_name} liquid light, atmospheric fog\n"
    "- 'Wave energy powers AI data centers' → underwater shot of a glowing data center pod "
    "tethered to a wave-energy buoy on the surface, sunlight refracted through water (still dark sea)\n"
    "- 'Plata reaches $5B valuation' → a single architectural tower of {agent_color_name} light "
    "rising from the Mexico City night skyline, NOT a cap table or a banknote\n"
    "- 'AI agents transact autonomously' → humanoid silhouettes made entirely of light particles "
    "exchanging glowing handprints over a dark obsidian table, NO money visible\n\n"
