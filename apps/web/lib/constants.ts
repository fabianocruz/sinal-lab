...
export const AGENT_PERSONAS = {
  sintese: {
    ...
    agentCode: 'SINTESE',
    color: '#E8FF59',
    description: 'Curadoria editorial e sintese semanal',
  ...
  radar: {
    ...
    agentCode: 'RADAR',
    color: '#59FFB4',
    description: 'Deteccao de tendencias emergentes',
  ...
  codigo: {
    ...
    agentCode: 'CODIGO',
    color: '#59B4FF',
    description: 'Analise de codigo e infraestrutura',
  ...
  mercado: {
    ...
    agentCode: 'MERCADO',
    color: '#C459FF',
    description: 'Inteligencia de mercado regional',
