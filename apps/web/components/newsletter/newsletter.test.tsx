...
describe('SearchBar', () => {
  it('test_searchbar_render_shows_default_placeholder', () => {
    ...
    expect(input).toHaveAttribute('placeholder', 'Buscar edicoes...');
  });
  ...
  it('test_searchbar_render_has_accessible_label', () => {
    ...
    expect(screen.getByLabelText('Buscar edicoes')).toBeInTheDocument();
  });
...
describe('FilterPills', () => {
  ...
  it('test_filterpills_render_shows_all_five_agent_pills', () => {
    ...
    expect(screen.getByText('Sintese')).toBeInTheDocument();
...
describe('Pagination', () => {
  ...
  it('test_pagination_render_previous_button_disabled_on_page_1', () => {
    ...
    const prev = screen.getByRole('button', { name: 'Pagina anterior' });
  ...
  it('test_pagination_render_next_button_disabled_on_last_page', () => {
    ...
    const next = screen.getByRole('button', { name: 'Proxima pagina' });
...
describe('FeaturedCard', () => {
  ...
  it('test_featuredcard_render_links_to_newsletter_slug', () => {
    ...
    const link = screen.getByRole('link', {
      name: `Ler edicao em destaque: ${mockNewsletter.title}`,
    });
    expect(link).toHaveAttribute('href', `/newsletter/${mockNewsletter.slug}`);
  });
...
describe('NewsletterArchivePage', () => {
  ...
  it('test_archivepage_render_shows_featured_card_for_first_newsletter', () => {
    ...
    // FeaturedCard uses "Ler edicao em destaque: …" as its aria-label
    expect(
      screen.getByRole('link', { name: `Ler edicao em destaque: ${featured.title}` }),
    ).toBeInTheDocument();
  });
...
describe('NewsletterSlugPage', () => {
  ...
  it('test_slugpage_render_shows_edition_number', () => {
    ...
    expect(
      screen.getByText(new RegExp(`Edicao #${validNewsletter.edition}`)),
    ).toBeInTheDocument();
  });
