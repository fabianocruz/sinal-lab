export default function BriefingExplainer() {
  return (
    <section id="briefing" className="border-b border-[rgba(255,255,255,0.04)] py-section">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-12 md:items-start">
          ...
          <div>
            ...
            <p className="mb-4 text-[16px] leading-[1.7] text-silver">
              O <strong className="text-sinal-white">Briefing Sinal</strong> é uma curadoria semanal
              de inteligência de mercado sobre o ecossistema tech da América Latina. Não é um
              agregador de notícias. É uma análise estruturada, com dados verificáveis e contexto
              que você não encontra em nenhum outro lugar.
            </p>
            <p className="mb-6 text-[16px] leading-[1.7] text-silver">
              Cada seção é pesquisada por agentes de IA especializados, validada por múltiplas
              fontes e revisada por editores humanos antes de chegar ao seu inbox.
            </p>
            <a
              href="#hero"
          ...
          <div className="overflow-hidden rounded-2xl border border-[rgba(255,255,255,0.06)] bg-sinal-graphite">
            ...
            <div className="border-b border-[rgba(255,255,255,0.06)] px-7 py-5">
              <div
                className="mb-2.5 flex items-center gap-2 font-mono text-[10px] uppercase tracking-[2px]"
                style={{ color: "#E8FF59" }}
              >
                <span
              ...
              <div className="text-[14px] leading-[1.6] text-ash">
                A avalanche de modelos open-source não é generosidade, é estratégia de comoditização
                da camada de inferência.
              </div>
            </div>
            ...
            <div className="border-b border-[rgba(255,255,255,0.06)] px-7 py-5">
              ...
              <div className="font-mono text-[13px] leading-[1.8] text-silver">
                ↗ AI agents em compliance regulatório LATAM
                <br />
                ↗ Migração de devs para Rust em infra de pagamentos
                <br />↘ Interesse de VCs em crypto-native fintech
              </div>
            </div>
            ...
            <div className="border-b border-[rgba(255,255,255,0.06)] px-7 py-5">
              ...
              >
                <span
                  className="inline-block h-[5px] w-[5px] rounded-full"
                  style={{ background: "#FF8A59" }}
                />
                FUNDING
              </div>
              <div
                className="rounded-r-md border-l-2 bg-[rgba(255,138,89,0.05)] py-3 pl-3.5 pr-3.5"
                style={{ borderLeftColor: "#FF8A59" }}
              >
                <div className="font-mono text-[12px] leading-[1.8] text-silver">
                  Serie B · Clip (MEX) · $50M · SoftBank
                  <br />
                  Serie A · Pomelo (ARG) · $18M · Kaszek
                  <br />
            ...
            <div className="px-7 py-5">
              ...
              >
                <span
                  className="inline-block h-[5px] w-[5px] rounded-full"
                  style={{ background: "#C459FF" }}
                />
                MERCADO
              </div>
              <div
                className="rounded-r-md border-l-2 bg-[rgba(196,89,255,0.05)] py-3 pl-3.5 pr-3.5"
                style={{ borderLeftColor: "#C459FF" }}
              >
                <div className="font-mono text-[12px] leading-[1.8] text-silver">
                  Launch · Koywe 2.0 (CHL) · Crypto Rails
                  <br />
                  Acquisition · Dock + processadora Peru
                  <br />
